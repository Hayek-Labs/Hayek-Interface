...
function Sidebar({ onSidebarHide, showSidebar }) {
  ...
  return (
    <div
      className={clsx(
        'inset-y-0 left-0 bg-card w-full xl:w sm:flex flex-col z-10',
      ...
      <div className="flex-shrink-0 overflow-hidden p-2">
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 sidebar-separator-top">
          ...
          <div
            ...
            className="block sm:hidden xl:block ml-2 font-bold text-xl text-white"
          >
            React
          </div>
...
function MenuItem({ item: { id, title, notifications }, onClick, selected }) {
  return (
    <div
      className={clsx(
        'mt-6 flex items-center px-3 sm:px-0 xl:px-3 justify-start sm:justify-center xl:justify-start sm:mt-6 xl:mt-3 cursor-pointer',
